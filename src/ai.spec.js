...
describe("AI", () => {
  it("Returns the next slot with which it can win", () => {
    [
      {config: {winningLength: 3},
       expectation: {iterationCounter: 4, slot: 0},
       board: [
      ...
      {config: {winningLength: 3},
       expectation: {iterationCounter: 7, slot: 2},
       board: [
      ...
      {config: {winningLength: 3},
       expectation: {iterationCounter: 9, slot: 1},
       board: [
  ...
  it("Returns the next slot with which it can prevent loosing", () => {
    ...
    [
      {config: {winningLength: 3},
       expectation: {iterationCounter: 34, slot: 0, score: 1},
       board: [
      ...
      {config: {winningLength: 3},
       expectation: {iterationCounter: 10, slot: 1, score: 1},
       board: [
        // other possible outcomes: draw or win
        [a,_,_],
        [a,_,_],
      ...
      {config: {winningLength: 3},
       expectation: {iterationCounter: 9, slot: 0, score: 1},
       board: [
        // other possible outcomes: draw or win
        [_,_,_],
        [_,_,0],
  ...
  it("Returns the best slot that can potentially lead to winning", () => {
    [
      {config: {winningLength: 3},
       expectation: {iterationCounter: 20, slot: 1},
       board: [
        [_,_,_],
        [_,_,_],
        [_,a,0],
      ...
      {config: {winningLength: 3},
       expectation: {iterationCounter: 7, slot: 1},
       board: [
        [_,_,_],
        [_,_,a],
        [0,a,0],
      ...
      {config: {winningLength: 3},
       expectation: {iterationCounter: 6, slot: 0},
       board: [
        [_,0,_],
        [0,a,_],
        [a,a,0],
  ...
  it("Yields different results based on iteration budget", () => {
    [
      {config: {winningLength: 3, iterationBudget: 1},
       expectation: {iterationCounter: 4, slot: 0, score: 0.5, maxIterationDepth: 1},
       board: [
        [_,_,_],
        [_,_,_],
        [_,a,0],
      ...
      {config: {winningLength: 3, iterationBudget: 10},
       expectation: {iterationCounter: 13, slot: 0, score: 0.5, maxIterationDepth: 2},
       board: [
        [_,_,_],
        [_,_,_],
        [_,a,0],
      ...
      {config: {winningLength: 3, iterationBudget: 50},
       expectation: {iterationCounter: 32, slot: 0, score: 0.5, maxIterationDepth: 3},
       board: [
        [_,_,_],
        [_,_,_],
        [_,a,0],
      ...
      {config: {winningLength: 3, iterationBudget: 100},
       expectation: {iterationCounter: 69, slot: 0, score: 0.5, maxIterationDepth: 4},
       board: [
        [_,_,_],
        [_,_,_],
        [_,a,0],
      ...
      {config: {winningLength: 3, iterationBudget: 500},
       expectation: {iterationCounter: 125, slot: 2, score: 0.5, maxIterationDepth: 5},
       board: [
        [_,_,_],
        [_,_,_],
        [_,a,0],
      ...
      {config: {winningLength: 3, iterationBudget: 1000},
       expectation: {iterationCounter: 20, slot: 1, score: 1, maxIterationDepth: 6},
       board: [
        [_,_,_],
        [_,_,_],
        [_,a,0],
